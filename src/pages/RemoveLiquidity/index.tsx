...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@cremepie/sdk'
...
export default function RemoveLiquidity({
  ...
  const [approval, approveCallback] = useApproveCallback(parsedAmounts[Field.LIQUIDITY], ROUTER_ADD_REMOVE_LIQUIDITY_ADDRESS)
  ...
  return (
    <>
      ...
      {pair &&
        <Wrapper style={{ width: '100%', maxWidth: '400px'}}>
